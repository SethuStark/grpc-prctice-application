...
public final class BankServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.myCode.models.BalanceCheckRequest,
      com.myCode.models.Balance> getGetBalanceMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "getBalance",
      requestType = com.myCode.models.BalanceCheckRequest.class,
      responseType = com.myCode.models.Balance.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.myCode.models.BalanceCheckRequest,
      com.myCode.models.Balance> getGetBalanceMethod() {
    io.grpc.MethodDescriptor<com.myCode.models.BalanceCheckRequest, com.myCode.models.Balance> getGetBalanceMethod;
      ...
      synchronized (BankServiceGrpc.class) {
        if ((getGetBalanceMethod = BankServiceGrpc.getGetBalanceMethod) == null) {
          BankServiceGrpc.getGetBalanceMethod = getGetBalanceMethod =
              io.grpc.MethodDescriptor.<com.myCode.models.BalanceCheckRequest, com.myCode.models.Balance>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "getBalance"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.myCode.models.BalanceCheckRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.myCode.models.Balance.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.myCode.models.WithdrawRequest,
      com.myCode.models.Money> getWithdrawMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "withdraw",
      requestType = com.myCode.models.WithdrawRequest.class,
      responseType = com.myCode.models.Money.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<com.myCode.models.WithdrawRequest,
      com.myCode.models.Money> getWithdrawMethod() {
    io.grpc.MethodDescriptor<com.myCode.models.WithdrawRequest, com.myCode.models.Money> getWithdrawMethod;
    if ((getWithdrawMethod = BankServiceGrpc.getWithdrawMethod) == null) {
      synchronized (BankServiceGrpc.class) {
        if ((getWithdrawMethod = BankServiceGrpc.getWithdrawMethod) == null) {
          BankServiceGrpc.getWithdrawMethod = getWithdrawMethod =
              io.grpc.MethodDescriptor.<com.myCode.models.WithdrawRequest, com.myCode.models.Money>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "withdraw"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.myCode.models.WithdrawRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.myCode.models.Money.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.myCode.models.DepositRequest,
      com.myCode.models.Balance> getCashDepositMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "cashDeposit",
      requestType = com.myCode.models.DepositRequest.class,
      responseType = com.myCode.models.Balance.class,
      methodType = io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
  public static io.grpc.MethodDescriptor<com.myCode.models.DepositRequest,
      com.myCode.models.Balance> getCashDepositMethod() {
    io.grpc.MethodDescriptor<com.myCode.models.DepositRequest, com.myCode.models.Balance> getCashDepositMethod;
      ...
      synchronized (BankServiceGrpc.class) {
        if ((getCashDepositMethod = BankServiceGrpc.getCashDepositMethod) == null) {
          BankServiceGrpc.getCashDepositMethod = getCashDepositMethod =
              io.grpc.MethodDescriptor.<com.myCode.models.DepositRequest, com.myCode.models.Balance>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "cashDeposit"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.myCode.models.DepositRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.myCode.models.Balance.getDefaultInstance()))
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void getBalance(com.myCode.models.BalanceCheckRequest request,
        io.grpc.stub.StreamObserver<com.myCode.models.Balance> responseObserver) {
     ...
     * </pre>
     */
    default void withdraw(com.myCode.models.WithdrawRequest request,
        io.grpc.stub.StreamObserver<com.myCode.models.Money> responseObserver) {
     ...
     * </pre>
     */
    default io.grpc.stub.StreamObserver<com.myCode.models.DepositRequest> cashDeposit(
        io.grpc.stub.StreamObserver<com.myCode.models.Balance> responseObserver) {
  ...
  public static final class BankServiceStub
     ...
     * </pre>
     */
    public void getBalance(com.myCode.models.BalanceCheckRequest request,
        io.grpc.stub.StreamObserver<com.myCode.models.Balance> responseObserver) {
     ...
     * </pre>
     */
    public void withdraw(com.myCode.models.WithdrawRequest request,
        io.grpc.stub.StreamObserver<com.myCode.models.Money> responseObserver) {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<com.myCode.models.DepositRequest> cashDeposit(
        io.grpc.stub.StreamObserver<com.myCode.models.Balance> responseObserver) {
  ...
  public static final class BankServiceBlockingStub
     ...
     * </pre>
     */
    public com.myCode.models.Balance getBalance(com.myCode.models.BalanceCheckRequest request) {
     ...
     * </pre>
     */
    public java.util.Iterator<com.myCode.models.Money> withdraw(
        com.myCode.models.WithdrawRequest request) {
  ...
  public static final class BankServiceFutureStub
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.myCode.models.Balance> getBalance(
        com.myCode.models.BalanceCheckRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_BALANCE:
          serviceImpl.getBalance((com.myCode.models.BalanceCheckRequest) request,
              (io.grpc.stub.StreamObserver<com.myCode.models.Balance>) responseObserver);
          break;
        case METHODID_WITHDRAW:
          serviceImpl.withdraw((com.myCode.models.WithdrawRequest) request,
              (io.grpc.stub.StreamObserver<com.myCode.models.Money>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.myCode.models.BalanceCheckRequest,
        ...
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncServerStreamingCall(
            new MethodHandlers<
              ...
              com.myCode.models.Money>(
                service, METHODID_WITHDRAW)))
        .addMethod(
          getCashDepositMethod(),
          io.grpc.stub.ServerCalls.asyncClientStreamingCall(
            new MethodHandlers<
              com.myCode.models.DepositRequest,
              com.myCode.models.Balance>(
  ...
  private static abstract class BankServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.myCode.models.BankServiceOuterClass.getDescriptor();
    }
