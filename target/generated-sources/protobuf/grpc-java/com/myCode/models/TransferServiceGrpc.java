...
public final class TransferServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.myCode.models.TransferRequest,
      com.myCode.models.TransferResponse> getTransferMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "transfer",
      requestType = com.myCode.models.TransferRequest.class,
      responseType = com.myCode.models.TransferResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<com.myCode.models.TransferRequest,
      com.myCode.models.TransferResponse> getTransferMethod() {
    io.grpc.MethodDescriptor<com.myCode.models.TransferRequest, com.myCode.models.TransferResponse> getTransferMethod;
      ...
      synchronized (TransferServiceGrpc.class) {
        if ((getTransferMethod = TransferServiceGrpc.getTransferMethod) == null) {
          TransferServiceGrpc.getTransferMethod = getTransferMethod =
              io.grpc.MethodDescriptor.<com.myCode.models.TransferRequest, com.myCode.models.TransferResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "transfer"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.myCode.models.TransferRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.myCode.models.TransferResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default io.grpc.stub.StreamObserver<com.myCode.models.TransferRequest> transfer(
        io.grpc.stub.StreamObserver<com.myCode.models.TransferResponse> responseObserver) {
  ...
  public static final class TransferServiceStub
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<com.myCode.models.TransferRequest> transfer(
        io.grpc.stub.StreamObserver<com.myCode.models.TransferResponse> responseObserver) {
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncBidiStreamingCall(
            new MethodHandlers<
              com.myCode.models.TransferRequest,
              com.myCode.models.TransferResponse>(
  ...
  private static abstract class TransferServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.myCode.models.TransferServiceOuterClass.getDescriptor();
    }
